export const load = () => {
    ...
    validButton.onclick = function() {
        if (senderIdInput.value != '' && passphraseInput.value != '') {
        ...
        } else if (passphraseInput.value != '' && senderIdInput.value == '') {
            alert('Missing address');
        } else if (senderIdInput.value != '' && passphraseInput.value == '') {
        ...
        xhr.onreadystatechange = function() {
            if (xhr.readyState === 4 && xhr.status === 200) {
                ...
                if (response.success == true && response.verified == true) {
                    ...
                    buffInfo.innerText =
                        'You can start playing your favorite game!';
    ...
    function getDotaEvents() {
        console.log('getDotaEvents fired');
        ...
        overwolf.games.events.onInfoUpdates2.addListener(function(info) {
            if (currentGame == 'Dota 2') {
                ...
                if (info.info && info.info.roster && info.info.roster.players) {
                    ...
                    dotaParams.allPlayers = JSON.parse(
                        ...
                        case 'match_ended':
                            ...
                            if (
                                ...
                                if (dotaParams.allPlayers) {
                                    dotaParams.allPlayers.forEach(function(
                                        player,
                                    ) {
                                        if (
                                            player.steamId ===
